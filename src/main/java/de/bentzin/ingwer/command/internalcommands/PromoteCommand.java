...
public class PromoteCommand extends IngwerCommand implements Permissioned, CommandUtils {
    ...
    private final StraightLineStringMessage is_superadmin = new StraightLineStringMessage("You cant change permissions of this Identity!");

    private final StraightLineStringMessage already_admin = new StraightLineStringMessage("The specified player is already admin");
